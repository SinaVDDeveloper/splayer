...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --cross-prefix=mipsel-linux-android- --arch=mips --cpu=mips32r2 --enable-runtime-cpudetect --enable-yasm --enable-asm --disable-mipsfpu --disable-mipsdspr1 --disable-mipsdspr2 --sysroot=/Users/sunxiao/android/android-ndk/platforms/android-9/arch-mips --prefix=./build/mips --enable-nonfree --enable-gpl --enable-version3 --disable-shared --enable-static --disable-symver --disable-programs --disable-doc --disable-avdevice --disable-encoders --disable-muxers --disable-devices --disable-debug --enable-optimizations --disable-filters --disable-avfilter --enable-bsfs --enable-parsers --disable-parser=hevc --enable-swscale --enable-network --extra-cflags='-I/Users/sunxiao/android/android-ndk/sources/cxx-stl/gnu-libstdc++/4.9/include -I/Users/sunxiao/android/android-ndk/sources/cxx-stl/gnu-libstdc++/4.9/libs/mips/include -fno-strict-aliasing -fmessage-length=0 -fno-inline-functions-called-once -frerun-cse-after-loop -frename-registers' --extra-ldflags=-L/Users/sunxiao/android/android-ndk/sources/cxx-stl/gnu-libstdc++/4.9/libs/mips --extra-cxxflags='-Wno-multichar -fno-exceptions -fno-rtti'
prefix=./build/mips
...
CC_IDENT=gcc 4.9 (GCC) 20140827 (peelease)
ARCH=mips
CC=mipsel-linux-android-gcc
CXX=mipsel-linux-android-g++
AS=mipsel-linux-android-gcc
LD=mipsel-linux-android-gcc
DEPCC=mipsel-linux-android-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=mipsel-linux-android-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
...
STRIP=mipsel-linux-android-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Users/sunxiao/android/android-ndk/platforms/android-9/arch-mips -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC
CFLAGS=  -I/Users/sunxiao/android/android-ndk/sources/cxx-stl/gnu-libstdc++/4.9/include -I/Users/sunxiao/android/android-ndk/sources/cxx-stl/gnu-libstdc++/4.9/libs/mips/include -fno-strict-aliasing -fmessage-length=0 -fno-inline-functions-called-once -frerun-cse-after-loop -frename-registers -march=mips32r2 -std=c99 -fomit-frame-pointer -fPIC -mips32r2 -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla
CXXFLAGS= -Wno-multichar -fno-exceptions -fno-rtti -D__STDC_CONSTANT_MACROS
ASFLAGS=  -I/Users/sunxiao/android/android-ndk/sources/cxx-stl/gnu-libstdc++/4.9/include -I/Users/sunxiao/android/android-ndk/sources/cxx-stl/gnu-libstdc++/4.9/libs/mips/include -fno-strict-aliasing -fmessage-length=0 -fno-inline-functions-called-once -frerun-cse-after-loop -frename-registers -march=mips32r2 -fPIC -mips32r2
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -L/Users/sunxiao/android/android-ndk/sources/cxx-stl/gnu-libstdc++/4.9/libs/mips  --sysroot=/Users/sunxiao/android/android-ndk/platforms/android-9/arch-mips -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
