...
public class MediaPlayer
{
    ...
    static {
    	try{
        	...
        	native_init(SPlayer.getLogDir(),SPLAYER_TRACE_ERROR, 1, 1);
    ...
    /*
    *logPath: where saving log file 
    *filter: see log filter
    *enableConsole: 1 log to logcat ; 0 not
    *enableFile: 1 log to file ; 0 not 
     */
    ...
    /* hard coded mode only support api level 16 and above
     ...
     * @param sv The SurfaceView to be used for the video portion of
     * the media.
     */
    public native void setDisplay(SurfaceView sv) 
		throws IllegalArgumentException, IllegalStateException;
	
    /**
     * Sets the Surface to be used as the sink for the video portion of
     * should be android.view.Surface
...
//    }
     ...
     *
     * @param bufSize msec total buffer time in mill second, default 5000 = 5 seconds
     */
     ...
     *
     * @param leftVolume left volume scalar [ 0 - 1 ] 
     * @param rightVolume right volume scalar  [ 0 - 1 ]
     */
...
//                    Log.i(TAG, "Info (" + msg.arg1 + "," + msg.arg2 + ")");
    ...
    public static final int MEDIA_ERROR_IO 			=	-1004;  // File or network related operation errors. 
    public static final int MEDIA_ERROR_MALFORMED 	=	-1007; // Bitstream is not conforming to the related coding standard or file spec. 
    public static final int MEDIA_ERROR_UNSUPPORTED =	-1010; // Bitstream is conforming to the related coding standard or file spec, but the media framework does not support the feature.
    public static final int MEDIA_ERROR_TIMED_OUT 	=	-110;  // Some operation takes too long to complete, usually more than 3-5 seconds.
    public static final int MEDIA_ERROR_DECODER_FAIL = 	-2000; //hardware decoder error
    /**
