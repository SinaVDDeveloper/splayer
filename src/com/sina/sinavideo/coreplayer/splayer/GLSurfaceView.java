...
//            }
        ...
        private void throwEglException(String function, int error) {
        	 String message = function + " failed: error="+error ; //String message = function + " failed: " + EGLLogWrapper.getErrorString(error);
            if (LOG_THREADS) {
...
//                        ConfigurationInfo.GL_ES_VERSION_UNDEFINED);
    ...
    private static GLThreadManager sGLThreadManager = null;///new GLThreadManager();
