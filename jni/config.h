...
#define FFMPEG_CONFIGURATION "--target-os=linux --cross-prefix=arm-linux-androideabi- --arch=arm --cpu=armv7-a --sysroot=/home/sina/work/tool/android-ndk-r9d/platforms/android-9/arch-arm --enable-nonfree --enable-gpl --enable-version3 --enable-static --disable-shared --disable-programs --disable-devices --disable-avdevice --disable-filters --disable-avfilter --disable-muxers --disable-encoders --enable-decoder=h264 --disable-decoder=h264_vdpau --disable-libstagefright-h264 --prefix=../build/stagefright/armeabi-v7a --extra-cflags='-I../android-source/frameworks/base/include -I../android-source/system/core/include -I../android-source/frameworks/base/media/libstagefright -I../android-source/frameworks/base/include/media/stagefright/openmax -I/home/sina/work/tool/android-ndk-r9d/sources/cxx-stl/gnu-libstdc++/4.6/include -I/home/sina/work/tool/android-ndk-r9d/sources/cxx-stl/gnu-libstdc++/4.6/libs/armeabi-v7a/include -march=armv7-a -mfloat-abi=softfp -mfpu=neon' --extra-ldflags='-Wl,--fix-cortex-a8 -L../android-libs -Wl,-rpath-link,../android-libs -L/home/sina/work/tool/android-ndk-r9d/sources/cxx-stl/gnu-libstdc++/4.6/libs/armeabi-v7a' --extra-cxxflags='-Wno-multichar -fno-exceptions -fno-rtti'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define FFMPEG_DATADIR "../build/stagefright/armeabi-v7a/share/ffmpeg"
#define AVCONV_DATADIR "../build/stagefright/armeabi-v7a/share/ffmpeg"
